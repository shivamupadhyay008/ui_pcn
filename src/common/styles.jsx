...
export const loginModalStyles = {
  backdrop:
    "fixed inset-0 z-50 flex items-center justify-center bg-black/30", // semi-transparent, change to bg-transparent for full clear

  container:
    "bg-white rounded-2xl shadow-xl p-6 w-[94%] max-w-lg animate-fadeIn relative",
